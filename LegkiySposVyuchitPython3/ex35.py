...
def gold_room():
    ...
    if how_much < 50:
        print('Шикарно! Ты не жадный, поэтому выйграешь!')
        exit(0)
    else:
        dead('Ах ты жадина!')
...
def bear_room():
    ...
    print('Медведь закрыл собой дверь входа.')
    ...
    while True:
        ...
        if choice == 'Отобрать мед':
            dead('Медведь посмотрел на тебя и ударил по лицу лапой.')
...
def start():
    ...
    print("Отсюда ведут две двери, налево и на право.")
    ...
    if choice =='налево':
        ...
        dead('Ты ходишь из комнаты в комнату, пока не умрешь от голоду.')
